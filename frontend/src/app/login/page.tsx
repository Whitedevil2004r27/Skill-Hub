...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Email/password login will be implemented in the next phase. Please use Google login for now.",
      variant: "default",
    });
  };
          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" disabled className="text-sm text-accent hover:text-accent/80 opacity-50 cursor-not-allowed">
                  Forgot password?
                </Link>
              </div>
