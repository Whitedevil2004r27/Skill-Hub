...
export default function CoursesPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Hero Section */}
        <section className="pt-20 pb-16 w-full px-6 md:px-12 lg:px-8">
        ...
        {/* Search and Filters */}
        <section className="pb-8 w-full px-6 md:px-12 lg:px-8">
        ...
        {/* Courses Grid */}
        <section className="pb-16 w-full px-6 md:px-12 lg:px-8">
          <div className="w-full">
