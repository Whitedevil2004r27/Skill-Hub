  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="w-full px-6 md:px-12 lg:px-8 relative z-10">
        ...
        >
          <div className="glass-card w-full p-12 md:p-16 border border-white/20 hover:shadow-purple-glow transition-all duration-500">
            {/* Icon */}
            <motion.div
              initial={{ scale: 0 }}
              whileInView={{ scale: 1 }}
              ...
              className="w-20 h-20  mb-8 bg-gradient-primary rounded-full flex items-center justify-center"
            >
            ...
            <motion.p
              ...
              className="text-xl text-white/80 mb-8 w-full  leading-relaxed"
            >
