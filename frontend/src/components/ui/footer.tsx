...
export const Footer = () => {
  return (
    <footer className="glass-card border-t border-white/10 text-white">
      <div className="w-full px-6 md:px-12 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/explore" className="text-white/80 hover:text-white transition-colors">Find Mentors</Link></li>
              <li><Link href="/become-mentor" className="text-white/80 hover:text-white transition-colors">Become a Mentor</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/guides" className="text-white/80 hover:text-white transition-colors">Guides</Link></li>
              <li><Link href="/docs" className="text-white/80 hover:text-white transition-colors">API Docs</Link></li>
            </ul>
          </div>
